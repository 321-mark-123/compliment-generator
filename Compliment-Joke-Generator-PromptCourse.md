...
Task
Generate the complete code for a responsive Compliment Generator web application.

The application should consist of three separate files:

index.html for the structure
style.css for the styling
script.js for the functionality
Context
The goal is to build a simple, visually appealing portfolio project.

The user will see a compliment displayed on the screen and a button to generate a new one.
The design should be modern, warm, and encouraging.
...
Format
Please provide the complete code for each of the three files.
Use Markdown code blocks for each file and clearly label them with their respective filenames:
